        ...
        <div class="add_utf_listing_section margin-top-45">
          ...
          <div class="utf_submit_section">
             <div class="row with-forms">
                 <div class="col-md-12">
                     @include('components.form-validation', ['id' => "sa-admission-validation",'style' => "margin-top: 10px;"])
                     <h5>Admission Session</h5>
                     <select id="sa-admission" class="selectpicker default" data-selected-text-format="count" data-size="{{count($schoolAdmissions)}}" title="Select session" tabindex="-98">
