...
<body class="header-one"> 
  <div id="main_wrapper">
    <!-- Header -->
    <header id="header_part" class="{{$headerClass}}">
            <div id="header" class="{{$headerDivClass}}">
                <div class="container">
                                ...
                                <div class="tab_content" id="tab1" style="display:none;">
                                    <form method="post" class="login">
                                        ...
                                        <p class="utf_row_form utf_form_wide_block">
                                            @include('components.form-validation', ['id' => "login-email-validation"])
                                            <label for="username">
                                        ...
                                        <p class="utf_row_form utf_form_wide_block has_validation">
                                           @include('components.form-validation', ['id' => "login-password-validation"])
                                            <label for="password">
                                        ...
                                        <div class="utf_row_form">
                                            @include('components.generic-loading', ['message' => 'Signing you in', 'id' => "login-loading"])
                                ...
                                <div class="tab_content" id="tab2" style="display:none;">
                                 <div class="row" id="signup-type-div">
                                   ...
                                   <form id="school-signup-form" method="post" class="register">
                                     ...
                                     <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-school-name-validation"])
                                           <label for="fname">
                                              <input type="text" class="input-text" id="school-signup-school-name" value="" placeholder="School name" />
                                           </label>
                                        </p>
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-email-validation"])
                                           <label for="fname">
                                              <input type="email" class="input-text" id="school-signup-email" value="" placeholder="Email address" />
                                           </label>
                                        </p>
                                        <p class="utf_row_form utf_form_wide_block">
                                         @include('components.form-validation', ['id' => "school-signup-country-validation"])
                                         <label for="fname">
                                        ...
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-phone-validation"])
                                        ...
                                        <p class="utf_row_form utf_form_wide_block">
                                         @include('components.form-validation', ['id' => "school-signup-hbu-validation"])
                                         <label for="fname">
                                       ...
                                       <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-hbu-other-validation"])
                                     ...
                                     <div id="school-signup-section-2">
                                        <p class="utf_row_form utf_form_wide_block">
                                        @include('components.form-validation', ['id' => "school-signup-boarding-type-validation"])
                                         <label for="fname">
                                        ...
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-school-fees-validation"])
                                           <label for="fname">
                                     ...
                                     <div id="school-signup-section-3">
                                         ...
                                         <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-wcu-validation",'message' => "This field is required and cannot be more than 400 characters"])
                                           <label for="fname">
                                     ...
                                     <h4>School Owner</h4>
                                      <p style="color: #000000;">Information about school owner</p>
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-owner-name-validation"])
                                           <label for="fname">
                                           <input class="input-text" type="text" id="school-signup-owner-name" placeholder="Full name" />
                                           </label>
                                        </p>
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-owner-phone-validation"])
                                           <label for="fname">
                                           <input class="input-text" type="email" id="school-signup-owner-phone" placeholder="Phone number" />
                                           </label>
                                        </p>
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-owner-email-validation"])
                                           <label for="fname">
                                     ...
                                     <div id="school-signup-section-5">
                                       <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-url-validation"])
                                           <label for="fname">
                                       ...
                                       <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-school-type-validation"])
                                           <label for="fname">
                                        ...
                                        <p class="utf_row_form utf_form_wide_block">
                                           @include('components.form-validation', ['id' => "school-signup-school-curriculum-validation"])
                                           <label for="fname">
                                        ...
                                        <div class="utf_row_form">
                                         @include('components.generic-loading', ['message' => 'Registering your school info', 'id' => "school-signup-loading"])
                                        </div>
                                    ...
                                    <h3 id="parent-signup-title">Parent Signup</h3>
                                        <div id="parent-signup-section-1">
                                          <p class="utf_row_form utf_form_wide_block">
                                            @include('components.form-validation', ['id' => "parent-signup-fname-validation"])
                                            <label for="fname">
                                          ...
                                          <p class="utf_row_form utf_form_wide_block">
                                            @include('components.form-validation', ['id' => "parent-signup-lname-validation"])
                                            <label for="fname">
                                          ...
                                          <p class="utf_row_form utf_form_wide_block">
                                            @include('components.form-validation', ['id' => "parent-signup-gender-validation"])
                                            <label for="fname">
                                        ...
                                        <div id="parent-signup-section-2">
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-email-validation"])
                                              <label for="fname">
                                                 <input type="text" class="input-text" id="parent-signup-email" value="" placeholder="Email address" />
                                              </label>
                                           </p>
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-phone-validation"])
                                              <label for="fname">
                                        ...
                                        <div id="parent-signup-section-3">
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-country-validation"])
                                              <label for="fname">
                                           ...
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-city-validation"])
                                              <label for="fname">
                                                 <input type="text" class="input-text" id="parent-signup-city" value="" placeholder="City" />
                                              </label>
                                           </p>
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-address-validation"])
                                              <label for="fname">
                                        ...
                                        <div id="parent-signup-section-4">
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-password-validation"])
                                              <label for="fname">
                                              <input class="input-text" type="password" id="parent-signup-password" placeholder="Password" />
                                              </label>
                                           </p>
                                           <p class="utf_row_form utf_form_wide_block">
                                              @include('components.form-validation', ['id' => "parent-signup-password2-validation"])
                                              <label for="fname">
                                              <input class="input-text" type="password" name="password2" id="parent-signup-password2" placeholder="Confirm Password" />
                                              </label>
                                           </p>
                                           <div class="utf_row_form">
                                            @include('components.generic-loading', ['message' => 'Signing you up', 'id' => "parent-signup-loading"])
                                           </div>
