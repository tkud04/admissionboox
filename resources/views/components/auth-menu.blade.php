...
<div class="utf_user_menu">
    <div class="utf_user_name"><span><img src="images/dashboard-avatar.jpg" alt=""></span>Hi, {{$fnameString}}!</div>
    <ul>
        <li><a href="{{url('dashboard')}}"><i class="sl sl-icon-layers"></i> Dashboard</a></li>
        <li><a href="{{url('dashboard')}}"><i class="sl sl-icon-user"></i> My Profile</a></li>
        <li><a href="{{url('dashboard')}}"><i class="sl sl-icon-list"></i> My Listing</a></li>
        <li><a href="{{url('dashboard')}}"><i class="sl sl-icon-envelope-open"></i> Messages</a></li>
        <li><a href="{{url('dashboard')}}"><i class="sl sl-icon-docs"></i> Booking</a></li>
