				...
				<?php
                 ...
                 ?>
				  <tr>
					...
					<td>
						<div>
                          <i class='im <?php echo e($f['icon']); ?>' style="font-size: 40px;"></i>
                        </div>
					</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tobikudayisi/repos/admissionboox/resources/views/facilities.blade.php ENDPATH**/ ?>