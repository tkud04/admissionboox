			...
			<div class="dashboard-list-box table-responsive invoices with-icons">
			  <table class="table table-hover admissionboox-table">
				...
				<tbody>
                 ...
                 ?>
				  <tr>
					<td><img alt="<?php echo e($school['name']); ?>" class="img-fluid rounded-circle shadow-lg" src="<?php echo e($school['name']); ?>" width="50" height="50"></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/repos/admissionboox/resources/views/admin-dashboard.blade.php ENDPATH**/ ?>