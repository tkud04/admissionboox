<div class="utf_dashboard_navigation js-scrollbar">
        <div class="utf_dashboard_navigation_inner_block">
            <ul>
                ...
                <li class="active"><a href="<?php echo e(url('add-admission')); ?>"><i class="sl sl-icon-plus"></i> Add Listing</a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="dashboard_visitor_review.html">Visitor Reviews <span
                                    class="nav-tag green">4</span></a></li>
                        <li><a href="dashboard_submitted_review.html">Submitted Reviews <span
...
</div><?php /**PATH /Users/mac/repos/admissionboox/resources/views/components/admin-sidebar.blade.php ENDPATH**/ ?>