     ...
     <div class="col-lg-12 col-md-12" id="edit-div">
       ...
       <div class="add_utf_listing_section margin-top-45">
         ...
         <div class="utf_submit_section">
          ...
          ?>
           <tr>
            <input type="hidden" id="fbes-<?php echo e($xf); ?>-title" value="<?php echo e($fs['title']); ?>">
            <input type="hidden" id="fbes-<?php echo e($xf); ?>-description" value="<?php echo e($fs['description']); ?>">
            ...
            <td>
              <ul class="list-inline">
                <li><a href="javascript:void 0" onclick="confirmRemoveFormSection('<?php echo e($xf); ?>')">Remove <i class="fa fa-trash"></i></a></li>
                <li><a href="#edit-form-section-div" onclick="editFormSection('<?php echo e($xf); ?>')">Edit <i class="fa fa-pencil"></i></a></li>
              </ul>
            </td>
           </tr>
          <?php
          ...
          ?>
           <tr>
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-title" value="<?php echo e($ff['title']); ?>">
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-type" value="<?php echo e($ff['type']); ?>">
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-xz" value="<?php echo e($xz); ?>">
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-description" value="<?php echo e($ff['description']); ?>">
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-bs_length" value="<?php echo e($ff['bs_length']); ?>">
           <input type="hidden" id="fbef-<?php echo e($xy); ?>-options" value="<?php echo e($ff['options']); ?>">
            ...
            <td>
              <ul class="list-inline">
                <li><a href="javascript:void 0" onclick="confirmRemoveFormField('<?php echo e($xy); ?>'); return false;">Remove <i class="fa fa-trash"></i></a></li>
                <li><a href="#edit-form-field-div" onclick="editFormField('<?php echo e($xy); ?>'); return false;">Edit <i class="fa fa-pencil"></i></a></li>
              </ul>
            ...
            <div class="utf_submit_section">
               ...
               <div class="col-md-12" id="fb-edit-component-div">
                  <div class="row with-forms">
                   ...
                   <div class="col-md-6">
                    <h5>Title</h5>
                    <?php echo $__env->make('components.form-validation', ['id' => "fbes-title-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <input type="text" class="input-text" name="fbes-title" id="fbes-title" placeholder="Title">
                   </div>
                   <div class="col-md-6">
                    <h5>Description</h5>
                    <?php echo $__env->make('components.form-validation', ['id' => "fbes-description-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               ...
               <div class="col-md-12">
               <?php echo $__env->make('components.generic-loading', ['message' => 'Editing section', 'id' => "fbes-loading"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="add_utf_listing_section margin-top-45" id="edit-form-field-div">
            ...
            <div class="utf_submit_section">
               ...
               <div class="col-md-12" id="fbef-div">
                  <div class="row with-forms">
                  <div class="col-md-6">
                   <?php echo $__env->make('components.form-validation', ['id' => "fbef-section-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                   <h5>Section</h5>
                   <select id="fbef-section" class="selectpicker default" data-selected-text-format="count" data-size="<?php echo e(count($formSections)); ?>"
                    title="Select term" tabindex="-98">
                     <option class="bs-title-option" value="none">Select section</option>
                     <?php
                      foreach($formSections as $fs)
                   ...
                   <div class="col-md-6">
                   <?php echo $__env->make('components.form-validation', ['id' => "fbef-type-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                   <h5>Field type</h5>
                   <select id="fbef-type" class="selectpicker default" data-selected-text-format="count" data-size="<?php echo e(count($fieldTypes)); ?>"
                    title="Select term" tabindex="-98">
                     <option class="bs-title-option" value="none">Select field type</option>
                     <?php
                      foreach($fieldTypes as $ft)
                   ...
                   <div class="col-md-6">
                    <h5>Title</h5>
                    <?php echo $__env->make('components.form-validation', ['id' => "fbef-title-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <input type="text" class="input-text" name="fbef-title" id="fbef-title" placeholder="Title">
                   </div>
                   <div class="col-md-6">
                    <h5>Description</h5>
                    <?php echo $__env->make('components.form-validation', ['id' => "fbef-description-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <input type="text" class="input-text" name="fbef-description" id="fbef-description" placeholder="Description">
                   </div>
                   <div class="col-md-6">
                   <h5>Field size (between 1 to 12)</h5>
                    <?php echo $__env->make('components.form-validation', ['id' => "fbef-bslength-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                   ...
                   <div class="col-md-12" id="options-div">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                       ...
                       <div class="col-md-6">
                         <h5>Name</h5>
                          <?php echo $__env->make('components.form-validation', ['id' => "fbef-add-option-name-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                          <input type="text" class="input-text" id="fbef-add-option-name" placeholder="Name">
                       </div>
                       <div class="col-md-6">
                         <h5>Value</h5>
                          <?php echo $__env->make('components.form-validation', ['id' => "fbef-add-option-value-validation",'style' => "margin-top: 10px;"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
