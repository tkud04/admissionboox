    ...
    $(document).ready(() => {
        ...
        $('#set-password-btn').click(e => {
            ...
            if(v){
              ...
              completeSchoolSignup(fd,
              (data) => {
                console.log('data: ',data)
                $('#set-password-btn').fadeIn()
              $('#set-password-loading').hide()
                if(data.status === 'ok'){
                    alert('Signup complete! Please login to continue')
                    window.location = '/'
                }
              ...
              (err) => {alert(`Failed to complete school signup: ${err}`)}
            )
            }
        })
    })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tobikudayisi/repos/admissionboox/resources/views/set-password.blade.php ENDPATH**/ ?>