    ...
    $(document).ready(() =>{
      $('#na-btn').click((e) => {
        ...
        clearValidations()
         ...
         naApplicationFee = $('#na-application-fee').val(), parsedApplicationFee = parseFloat(naApplicationFee)
         
         //console.log({naSession,naTerm,naClass,naEndDate})
 
         const v = naSession === 'none' || naTerm === 'none' || naClasses.length < 1 || naEndDate === '' ||
                   (naApplicationFee === '' || parsedApplicationFee < 0)
         ...
         if(v){
           ...
           if(naApplicationFee === '' || parsedApplicationFee < 0) $('#na-application-fee-validation').fadeIn()
         }
         else{
          $('#na-btn').hide()
          $('#na-loading').fadeIn()
          ...
          <ul>
            ...
            ?>
               ...
               <div class="col-md-6">
                 ...
                 <input type="number" class="input-text" name="address" id="na-application-fee" value="<?php echo e($admission['application_fee']); ?>">
               </div>
