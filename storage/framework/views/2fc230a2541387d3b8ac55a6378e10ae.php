...
<div class="col-lg-12 col-md-12">
  ...
  ?>
          ...
          <div class="col-md-4">
					...
					<div class="col-md-4">
						<label>Role</label>						
						<input type="text" class="input-text" placeholder="User role" value="<?php echo e(ucwords($user->role)); ?>" disabled>
					</div>
                    <div class="col-md-4">
						<label>Gender</label>						
						<input type="text" class="input-text" placeholder="Gender" value="<?php echo e(ucwords($user->gender)); ?>" disabled>
					</div>
					<div class="col-md-12">
						<label>Address</label>
						<textarea name="notes" cols="30" rows="10" disabled><?php echo e($address); ?></textarea>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tobikudayisi/repos/admissionboox/resources/views/user-profile.blade.php ENDPATH**/ ?>